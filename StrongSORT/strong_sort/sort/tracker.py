...
class Tracker:
    ...
    def __init__(self, metric, max_iou_distance=0.9, max_age=30, n_init=2, _lambda=0, ema_alpha=0.9, mc_lambda=0.995):
        self.metric = metric
    ...
    def update(self, detections, classes, confidences):
        ...
        for track_idx, detection_idx in matches:
            ...
            original_detections = detections[detection_idx]
            modified_detections = detections

            original_classes = classes[detection_idx]
            modified_classes = classes

            original_conf = confidences[detection_idx]
            modified_conf = confidences

            self.tracks[track_idx].update(
                #detections[detection_idx], classes[detection_idx], confidences[detection_idx])
                original_detections, original_classes, modified_conf)
            print('detection idx', detection_idx)

            print('modified classes', modified_classes)
            print('modified conf', modified_conf)
        ...
        for detection_idx in unmatched_detections:
            ...
            #self._initiate_track(modified_detections, modified_classes.item(), modified_conf.item())
    ...
    def _match(self, detections):
        ...
        print('confirmed tracks', confirmed_tracks)
        print('unconfirmed tracks', unconfirmed_tracks)
        ...
        print('linear assignment matches (a):', matches_a)
        print('linear assignment unmtached_tracks (a)', unmatched_tracks_a)
        ...
        print('linear assignment matches (b):', matches_b)
        print('linear assignment unmtached_tracks (b)', unmatched_tracks_b)
